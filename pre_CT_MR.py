...
# 训练自定义肺癌数据集
modality = "CT"
anatomy = "LiTS"  # anantomy + dataset name
img_name_suffix = ".nii.gz"
gt_name_suffix = "_seg.nii.gz"
prefix = modality + "_" + anatomy + "_"

nii_path = "data/LiTS/images"  # path to the nii images
gt_path = "data/LiTS/labels"  # path to the ground truth
npy_path = "data/npy/" + prefix[:-1]
os.makedirs(join(npy_path, "gts"), exist_ok=True)
os.makedirs(join(npy_path, "imgs"), exist_ok=True)
...
for name in tqdm(names[:10]):  # use the remaining 10 cases for validation
